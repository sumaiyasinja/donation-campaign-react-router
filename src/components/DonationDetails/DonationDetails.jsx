...
const DonationDetails = () => {
    ...
    const notify = () => toast.success("Doanted!");
    ...
    return (
        ...
        <div className='absolute bottom-0 left-0 right-0 '>
            ...
            <buttons onClick={notify} className='cursor-pointer absolute mx-10 bg-red-500 text-white py-3 px-6 rounded-lg z-10 bottom-4'>
